...
export class Ajax extends Component<IAjaxProps> {
    state: { loading: boolean, data: unknown, error: AxiosError|null } = { loading: true, data: undefined, error: null };
    ...
    componentDidMount(): void {
        ...
        axios.get(`${loc.protocol}//${loc.hostname}:8000${this.props.url}`)
            .then(response => {
